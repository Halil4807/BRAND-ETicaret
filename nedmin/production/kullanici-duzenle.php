                    ...
                    <br />
                      <!-- 
                          ...
                          <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Mail Adresi <span class="required">*</span></label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="kullanici_yetki" required>
                                  <option value="5" <?php echo $kullanicicek['kullanici_yetki']=='5'?'selected=""':''; ?>>Admin</option>
                                  <option value="0" <?php if($kullanicicek['kullanici_yetki']=='0') {echo 'selected=""';} ?>>User</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
